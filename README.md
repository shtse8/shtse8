...
| Project                 | Description                                      | Key Tech                               | Links                                                                                                                                                                                                                            |
| :---------------------- | :----------------------------------------------- | :------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Big 2 Tycoon**        | Multiplayer card game with ELO & tournaments     | `Unity3D`, `TypeScript`, `Node.js`     | [Google Play](https://play.google.com/store/apps/details?id=com.gameflask.btthk) / [App Store](https://apps.apple.com/az/app/%E9%8B%A4%E5%A4%A7d%E5%A4%A7%E4%BA%A8-%E6%9C%80%E5%88%BA%E6%BF%80%E7%9A%84%E7%AD%96%E7%95%A5%E6%A3%8B%E7%89%8C%E9%81%8A%E6%88%B2/id1295634408) |
| **Nakuz.com**           | #1 HK gaming portal (500k+ users)                | `React`, `Next.js`, `PHP`, `MySQL`     | [Website](https://nakuz.com/)                                                                                                                                                                                                    |
| **Quant Trading Sys**   | Algorithmic trading platform                     | `Go`, `Python`, `PyTorch`, `GCP`       | *Internal*                                                                                                                                                                                                                       |
| **Portfolio Website**   | This portfolio site                              | `Next.js`, `TypeScript`, `Tailwind`    | [GitHub](https://github.com/shtse8/portfolio) / [Website](https://kylet.se)                                                                                                                                                      |
| **Google Photos Tool**  | Chrome Extension for bulk deletion (2k+ users)   | `Node.js`, `JavaScript`, `Chrome API`  | [GitHub](https://github.com/shtse8/google-photos-delete-tool) / [Store](https://chromewebstore.google.com/detail/google-photos-delete-tool/jiahfbbfpacpolomdjlpdpiljllcdenb)                                                  |

*For a full list of projects, please visit my [Portfolio Website](https://kylet.se).*

---

## 🌱 Core Philosophy

Purposeful Minimalism • User-Centricity • Clarity • Efficiency • Systematic Thinking • Openness • Intuitiveness • Reusability • Adaptability • Content-First • Purposeful Aesthetics • Breathing Room
